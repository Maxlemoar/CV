export const PROFILE_CONTENT = `# Maximilian Veit Marowsky — Profile
...
- **Labs is the convergence**: Founder experience (0-to-1, pivot, acquisition), intrapreneurship (finding product-market fit inside a larger organization), and daily hands-on prototyping with Claude Code (~10 side projects) converge in this exact role — a team that turns research into products that didn't exist before. His psychology and education background is proof he can go deep in a domain and flex into new ones.
