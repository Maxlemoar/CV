...
- **Labs is the convergence**: Founder experience (founding, pivot, acquisition), intrapreneurship (growing a product inside a larger organization), and daily hands-on prototyping with Claude Code (~10 side projects) converge in this exact role — the team that turned research into Claude Code and MCP. His psychology and education background shows he can go deep in a domain and move into new ones.
