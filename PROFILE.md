...
I fell in love with the product first. Then I listened to Boris Cherny on Lenny's Podcast and was immediately hooked — I wanted to understand the company behind the product. Since then, I've listened to every podcast episode featuring Anthropic's team I could find. The picture that emerged was consistent: maximum autonomy, encouragement to build beyond your role, a culture that rewards questioning your own assumptions rather than defending them. That's the environment I do my best work in and learn the most. I set up a Greenhouse alert for "Product Manager" that same day.

I'm deeply purpose-driven. That's what brought me from psychology into EdTech, and it's what draws me to Anthropic now. I could never work for a company where the mission is an afterthought. Anthropic puts it first — and it shows. Claude has the kind of integrity that education demands. That's not a nice-to-have when you're building products for learners, it's foundational. Education Labs is where everything I've done converges: psychology, learning science, founder experience, product management, AI. The topic closest to my heart, in a company that doesn't constrain but amplifies.
